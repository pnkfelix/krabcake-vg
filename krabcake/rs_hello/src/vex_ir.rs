...
pub enum IROp {
    ...
    */
    ...
    Iop_I32UtoF32x2_DEP,
    Iop_I32StoF32x2_DEP, /* I32x2 -> F32x2 */

    Iop_F32toI32Ux2_RZ,
    Iop_F32toI32Sx2_RZ, /* F32x2 -> I32x2 */
    ...
    */
    ...
    Iop_I32UtoF32x4_DEP,
    Iop_I32StoF32x4_DEP, /* I32x4 -> F32x4 */

    Iop_I32StoF32x4, /* IRRoundingMode(I32) x V128 -> V128 */
    Iop_F32toI32Sx4, /* IRRoundingMode(I32) x V128 -> V128 */

    Iop_F32toI32Ux4_RZ,
    Iop_F32toI32Sx4_RZ, /* F32x4 -> I32x4       */
    Iop_QF32toI32Ux4_RZ,
    Iop_QF32toI32Sx4_RZ, /* F32x4 -> I32x4 (saturating) */
    Iop_RoundF32x4_RM,
    ...
    */
    ...
    /* Pack even/odd lanes. */
    Iop_PackOddLanes8x16,
    Iop_PackEvenLanes8x16,
    Iop_PackOddLanes16x8,
    Iop_PackEvenLanes16x8,
    Iop_PackOddLanes32x4,
...
impl IROp {
    pub fn is_widening(op: i64) -> bool {
        (IROp::Iop_8Uto16 as i64 <= op) && (op <= IROp::Iop_32Sto64 as i64)
    }
    pub fn is_narrowing(op: i64) -> bool {
        (IROp::Iop_64to8 as i64 <= op) && (op <= IROp::Iop_64to16 as i64)
    }
}
